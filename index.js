...
client.once("ready", async () => {
  // Start of Bot Status
  client.user.setActivity("Sounak's brain!", { type: ActivityType.Watching });
  //End of bot status
  ...
  await client.guilds.cache.get(config.discord.mainServer).commands.set(staffcommands); // guild commands for FS Automations (includes the rest of the commands)
  await client.guilds.cache.get(config.discord.mainServer).commands.set(staffcommands); // this should be for FSS, suman add the FSS guild id here
  ready = true;
